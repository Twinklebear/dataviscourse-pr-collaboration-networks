...
is cleaner while also communicating that there are a lot of collaborations between the blue and red bundles. There is a bug that we weren't able to fix in time is the display of edges would change back to defaut width's size when panning the view. 
